...
- Slides (`.pptx`), built from the course-provided template.
- The recorded 10–15 minute presentation — **link only** (unlisted YouTube). Do not commit
  video files.
...
- **Three distinct pairs** of AS-IS / TO-BE scenarios, covering different *aspects* of the
  application — not three variations of the same walk-through. This is success criterion SC-3
...
`<UNLISTED YOUTUBE LINK — add here and on Canvas>`
