...
ahead of submission, and why the D-3 owner starts on Problems and Goals in that same week from
the *draft* issues list rather than waiting for D-2 to be final.
